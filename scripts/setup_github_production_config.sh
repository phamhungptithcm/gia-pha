...
set_var_if_present BILLING_QR_CHECKOUT_ENABLED
set_var_if_present BILLING_CARD_CHECKOUT_URL_BASE
set_var_if_present BILLING_VNPAY_FALLBACK_URL
set_var_if_present BILLING_VNPAY_GATEWAY_BASE_URL
set_var_if_present VNPAY_RETURN_URL
set_var_if_present BILLING_VNPAY_IP_ADDRESS
set_var_if_present BILLING_VNPAY_LOCALE
set_var_if_present BILLING_QR_IMAGE_BASE_URL
set_var_if_present BILLING_QR_IMAGE_PLUS_URL
set_var_if_present BILLING_QR_IMAGE_PRO_URL
...
set_secret_if_present VNPAY_TMNCODE
set_secret_if_present VNPAY_HASH_SECRET
