...
const clanId = 'clan_seed_001';
const clanOwnerUid = 'seed_uid_member_seed_parent_001';
...
const members = [
  ...
  createMember({
    id: 'member_seed_elder_spouse_001',
    branchId: 'branch_seed_001',
    fullName: 'Bà Mai',
    nickName: 'Mai',
    gender: 'female',
  ...
  createMember({
    id: 'member_seed_uncle_spouse_001',
    branchId: 'branch_seed_001',
  ...
  createMember({
    id: 'member_seed_aunt_spouse_001',
    branchId: 'branch_seed_002',
  ...
  createMember({
    id: 'member_seed_branch3_lead_001',
    branchId: 'branch_seed_003',
    fullName: 'Nguyễn Văn Đại',
    nickName: 'Đại',
    gender: 'male',
    birthDate: '1997-02-25',
    phoneE164: '+84905550123',
    generation: 5,
    primaryRole: 'BRANCH_ADMIN',
    jobTitle: 'Trưởng chi 3',
  }),
  createMember({
    id: 'member_seed_branch3_spouse_001',
    branchId: 'branch_seed_003',
  ...
  createMember({
    id: 'member_seed_branch4_lead_001',
    branchId: 'branch_seed_004',
  ...
  createMember({
    id: 'member_seed_branch4_spouse_001',
    branchId: 'branch_seed_004',
  ...
  createMember({
    id: 'member_seed_branch3_member_001',
    branchId: 'branch_seed_003',
    fullName: 'Lê Văn Vũ',
    nickName: 'Vũ',
    gender: 'male',
  ...
  createMember({
    id: 'member_seed_branch3_member_spouse_001',
    branchId: 'branch_seed_003',
  ...
  createMember({
    id: 'member_seed_branch4_child_002',
    branchId: 'branch_seed_004',
  ...
  createMember({
    id: 'member_seed_branch3_child_001',
    branchId: 'branch_seed_003',
    fullName: 'Lê Văn Kỳ',
    nickName: 'Kỳ',
    gender: 'male',
  ...
  createMember({
    id: 'member_seed_branch3_child_002',
    branchId: 'branch_seed_003',
  ...
  createMember({
    id: 'member_seed_branch4_child_001',
    branchId: 'branch_seed_004',
  ...
  createMember({
    id: 'member_seed_branch4_child_spouse_001',
    branchId: 'branch_seed_004',
  ...
  createMember({
    id: 'member_seed_branch3_grandchild_001',
    branchId: 'branch_seed_003',
  ...
  createMember({
    id: 'member_seed_branch4_grandchild_001',
    branchId: 'branch_seed_004',
...
const additionalMembers = [
  ...
  createMember({
    id: 'member_seed_b1_elder_spouse_001',
    branchId: 'branch_seed_001',
    fullName: 'Đỗ Thị Mến',
    nickName: 'Bà Mến',
    gender: 'female',
  ...
  createMember({
    id: 'member_seed_b1_parent_spouse_003',
    branchId: 'branch_seed_001',
  ...
  createMember({
    id: 'member_seed_b2_elder_spouse_001',
    branchId: 'branch_seed_002',
  ...
  createMember({
    id: 'member_seed_b2_parent_spouse_003',
    branchId: 'branch_seed_002',
  ...
  createMember({
    id: 'member_seed_b3_parent_spouse_002',
    branchId: 'branch_seed_003',
  ...
  createMember({
    id: 'member_seed_b3_child_spouse_003',
    branchId: 'branch_seed_003',
  ...
  createMember({
    id: 'member_seed_b3_grandchild_002',
    branchId: 'branch_seed_003',
  ...
  createMember({
    id: 'member_seed_b4_parent_spouse_002',
    branchId: 'branch_seed_004',
  ...
  createMember({
    id: 'member_seed_b4_child_spouse_003',
    branchId: 'branch_seed_004',
  ...
  createMember({
    id: 'member_seed_b4_grandchild_002',
    branchId: 'branch_seed_004',
...
const relationships = [
  createSpouse('member_seed_ancestor_001', 'member_seed_ancestor_002'),
  createSpouse('member_seed_elder_001', 'member_seed_elder_spouse_001'),
  createSpouse('member_seed_parent_001', 'member_seed_spouse_001'),
  createSpouse('member_seed_parent_002', 'member_seed_spouse_002'),
  createSpouse('member_seed_uncle_001', 'member_seed_uncle_spouse_001'),
  createSpouse('member_seed_aunt_001', 'member_seed_aunt_spouse_001'),
  createSpouse('member_seed_branch3_lead_001', 'member_seed_branch3_spouse_001'),
  createSpouse(
    'member_seed_branch3_member_001',
    'member_seed_branch3_member_spouse_001',
  ),
  createSpouse('member_seed_branch4_lead_001', 'member_seed_branch4_spouse_001'),
  createParentChild('member_seed_ancestor_001', 'member_seed_elder_001'),
  createParentChild('member_seed_ancestor_002', 'member_seed_elder_001'),
  createParentChild('member_seed_elder_001', 'member_seed_parent_001'),
  createParentChild('member_seed_elder_spouse_001', 'member_seed_parent_001'),
  createParentChild('member_seed_elder_001', 'member_seed_parent_002'),
  createParentChild('member_seed_elder_spouse_001', 'member_seed_parent_002'),
  createParentChild('member_seed_elder_001', 'member_seed_uncle_001'),
  createParentChild('member_seed_elder_spouse_001', 'member_seed_uncle_001'),
  createParentChild('member_seed_elder_001', 'member_seed_aunt_001'),
  createParentChild('member_seed_elder_spouse_001', 'member_seed_aunt_001'),
  createParentChild('member_seed_parent_001', 'member_seed_child_001'),
  createParentChild('member_seed_spouse_001', 'member_seed_child_001'),
  createParentChild('member_seed_parent_001', 'member_seed_child_003'),
  createParentChild('member_seed_spouse_001', 'member_seed_child_003'),
  createParentChild('member_seed_parent_002', 'member_seed_child_002'),
  createParentChild('member_seed_spouse_002', 'member_seed_child_002'),
  createParentChild('member_seed_parent_002', 'member_seed_child_004'),
  createParentChild('member_seed_spouse_002', 'member_seed_child_004'),
  createParentChild('member_seed_uncle_001', 'member_seed_cousin_001'),
  createParentChild('member_seed_uncle_spouse_001', 'member_seed_cousin_001'),
  createParentChild('member_seed_uncle_001', 'member_seed_cousin_002'),
  createParentChild('member_seed_uncle_spouse_001', 'member_seed_cousin_002'),
  createParentChild('member_seed_uncle_001', 'member_seed_branch3_lead_001'),
  createParentChild(
    'member_seed_uncle_spouse_001',
    'member_seed_branch3_lead_001',
  ),
  createParentChild('member_seed_aunt_001', 'member_seed_cousin_003'),
  createParentChild('member_seed_aunt_spouse_001', 'member_seed_cousin_003'),
  createParentChild('member_seed_aunt_001', 'member_seed_branch4_lead_001'),
  createParentChild('member_seed_aunt_spouse_001', 'member_seed_branch4_lead_001'),
  createParentChild('member_seed_branch3_lead_001', 'member_seed_branch3_child_001'),
  createParentChild(
    'member_seed_branch3_spouse_001',
    'member_seed_branch3_child_001',
  ),
  createParentChild('member_seed_branch3_lead_001', 'member_seed_branch3_child_002'),
  createParentChild(
    'member_seed_branch3_spouse_001',
    'member_seed_branch3_child_002',
  ),
  createParentChild('member_seed_branch3_member_001', 'member_seed_branch3_grandchild_001'),
  createParentChild(
    'member_seed_branch3_member_spouse_001',
    'member_seed_branch3_grandchild_001',
  ),
  createParentChild('member_seed_branch4_lead_001', 'member_seed_branch4_child_001'),
  createParentChild(
    'member_seed_branch4_spouse_001',
    'member_seed_branch4_child_001',
  ),
  createParentChild(
    'member_seed_branch4_lead_001',
    'member_seed_branch4_child_spouse_001',
  ),
  createParentChild(
    'member_seed_branch4_spouse_001',
    'member_seed_branch4_child_spouse_001',
  ),
  createParentChild('member_seed_branch4_lead_001', 'member_seed_branch4_child_002'),
  createParentChild(
    'member_seed_branch4_spouse_001',
    'member_seed_branch4_child_002',
  ),
  createParentChild(
    'member_seed_branch4_lead_001',
    'member_seed_branch4_grandchild_001',
  ),
  createParentChild(
    'member_seed_branch4_spouse_001',
    'member_seed_branch4_grandchild_001',
...
const additionalRelationships = [
  createSpouse('member_seed_b1_elder_001', 'member_seed_b1_elder_spouse_001'),
  createSpouse('member_seed_b1_parent_003', 'member_seed_b1_parent_spouse_003'),
  createParentChild('member_seed_b1_elder_001', 'member_seed_b1_parent_003'),
  createParentChild(
    'member_seed_b1_elder_spouse_001',
    'member_seed_b1_parent_003',
  ),
  createParentChild('member_seed_b1_parent_003', 'member_seed_b1_child_005'),
  createParentChild(
    'member_seed_b1_parent_spouse_003',
    'member_seed_b1_child_005',
  ),
  createParentChild('member_seed_b1_parent_003', 'member_seed_b1_child_006'),
  createParentChild(
    'member_seed_b1_parent_spouse_003',
    'member_seed_b1_child_006',
  ),
  createSpouse('member_seed_b2_elder_001', 'member_seed_b2_elder_spouse_001'),
  createSpouse('member_seed_b2_parent_003', 'member_seed_b2_parent_spouse_003'),
  createParentChild('member_seed_b2_elder_001', 'member_seed_b2_parent_003'),
  createParentChild(
    'member_seed_b2_elder_spouse_001',
    'member_seed_b2_parent_003',
  ),
  createParentChild('member_seed_b2_parent_003', 'member_seed_b2_child_005'),
  createParentChild(
    'member_seed_b2_parent_spouse_003',
    'member_seed_b2_child_005',
  ),
  createParentChild('member_seed_b2_parent_003', 'member_seed_b2_child_006'),
  createParentChild(
    'member_seed_b2_parent_spouse_003',
    'member_seed_b2_child_006',
  ),
  createSpouse('member_seed_b3_parent_002', 'member_seed_b3_parent_spouse_002'),
  createSpouse('member_seed_b3_child_003', 'member_seed_b3_child_spouse_003'),
  createParentChild('member_seed_b3_parent_002', 'member_seed_b3_child_003'),
  createParentChild(
    'member_seed_b3_parent_spouse_002',
    'member_seed_b3_child_003',
  ),
  createParentChild('member_seed_b3_parent_002', 'member_seed_b3_child_004'),
  createParentChild(
    'member_seed_b3_parent_spouse_002',
    'member_seed_b3_child_004',
  ),
  createParentChild('member_seed_b3_child_003', 'member_seed_b3_grandchild_002'),
  createParentChild(
    'member_seed_b3_child_spouse_003',
    'member_seed_b3_grandchild_002',
  ),
  createSpouse('member_seed_b4_parent_002', 'member_seed_b4_parent_spouse_002'),
  createSpouse('member_seed_b4_child_003', 'member_seed_b4_child_spouse_003'),
  createParentChild('member_seed_b4_parent_002', 'member_seed_b4_child_003'),
  createParentChild(
    'member_seed_b4_parent_spouse_002',
    'member_seed_b4_child_003',
  ),
  createParentChild('member_seed_b4_parent_002', 'member_seed_b4_child_004'),
  createParentChild(
    'member_seed_b4_parent_spouse_002',
    'member_seed_b4_child_004',
  ),
  createParentChild('member_seed_b4_child_003', 'member_seed_b4_grandchild_002'),
  createParentChild(
    'member_seed_b4_child_spouse_003',
    'member_seed_b4_grandchild_002',
  ),
];
...
const branches = [
  {
    ...
    name: 'Chi Trưởng',
    code: 'CT01',
    leaderMemberId: 'member_seed_parent_001',
    viceLeaderMemberId: 'member_seed_parent_002',
  ...
  },
  {
    ...
    name: 'Chi Phụ',
    code: 'CP02',
    leaderMemberId: 'member_seed_parent_002',
    viceLeaderMemberId: 'member_seed_elder_001',
  ...
  },
  {
    ...
    name: 'Chi Thành Đạt',
    code: 'CTD03',
    leaderMemberId: 'member_seed_branch3_lead_001',
    viceLeaderMemberId: 'member_seed_uncle_001',
  ...
  },
  {
    ...
    name: 'Chi Hạnh Phúc',
    code: 'CHP04',
    leaderMemberId: 'member_seed_branch4_lead_001',
    viceLeaderMemberId: 'member_seed_aunt_spouse_001',
    generationLevelHint: 5,
    status: 'active',
    memberCount: 0,
    createdAt: now,
...
assertDemographicQuality({
  ...
  relationships,
  creatorId: 'member_seed_parent_001',
});
...
const invites = [
  ...
  },
  {
    ...
    clanId,
    branchId: 'branch_seed_003',
    memberId: 'member_seed_branch3_lead_001',
    inviteType: 'phone_claim',
    phoneE164: '+84905550123',
    childIdentifier: null,
    status: 'pending',
  ...
  },
  {
    ...
    clanId,
    branchId: 'branch_seed_004',
    memberId: 'member_seed_branch4_lead_001',
    inviteType: 'phone_claim',
    phoneE164: '+84907770111',
    childIdentifier: null,
    status: 'pending',
  ...
  },
  {
    ...
    clanId,
    branchId: 'branch_seed_001',
    memberId: 'member_seed_child_001',
  ...
  },
  {
    ...
    clanId,
    branchId: 'branch_seed_002',
    memberId: 'member_seed_child_002',
    inviteType: 'child_access',
    phoneE164: '+84908886655',
  ...
  },
  {
    ...
    clanId,
    branchId: 'branch_seed_001',
    memberId: 'member_seed_child_003',
    inviteType: 'child_access',
    phoneE164: '+84901234567',
  ...
  },
  {
    ...
    clanId,
    branchId: 'branch_seed_002',
    memberId: 'member_seed_child_004',
    inviteType: 'child_access',
    phoneE164: '+84908886655',
...
const fundTransactions = [
  {
    ...
    createdBy: 'member_seed_parent_001',
    updatedAt: now,
    updatedBy: 'seed-script',
  },
  {
  ...
  },
  {
    ...
    createdBy: 'member_seed_parent_002',
    updatedAt: now,
    updatedBy: 'seed-script',
  },
  {
...
const funds = [
  {
    id: 'fund_seed_scholarship',
    clanId,
    branchId: null,
    appliedMemberIds: [
      'member_seed_child_001',
      'member_seed_child_002',
      'member_seed_child_003',
      'member_seed_child_004',
    ],
    treasurerMemberIds: ['member_seed_parent_001', 'member_seed_parent_002'],
    name: 'Quỹ Khuyến học',
    description: 'Hỗ trợ hậu duệ với học bổng thường niên.',
    fundType: 'scholarship',
    currency: 'VND',
    balanceMinor: fundBalanceById.get('fund_seed_scholarship') ?? 0,
    status: 'active',
    createdAt: now,
    createdBy: 'seed-script',
    updatedAt: now,
  ...
  {
    id: 'fund_seed_operations',
    clanId,
    branchId: null,
    appliedMemberIds: [],
    treasurerMemberIds: ['member_seed_parent_002'],
    name: 'Quỹ Vận hành họ tộc',
    description: 'Chi trả nghi lễ và hoạt động chung của họ tộc.',
    fundType: 'operations',
    currency: 'VND',
    balanceMinor: fundBalanceById.get('fund_seed_operations') ?? 0,
    status: 'active',
    createdAt: now,
    createdBy: 'seed-script',
    updatedAt: now,
...
const scholarshipPrograms = [
  {
    id: 'scholarship_program_seed_2026',
    clanId,
...
const awardLevels = [
  {
    id: 'award_level_seed_gold',
    programId: 'scholarship_program_seed_2026',
    clanId,
    name: 'Giải Vàng',
...
const achievementSubmissions = [
  {
    ...
    programId: 'scholarship_program_seed_2026',
    awardLevelId: 'award_level_seed_gold',
    clanId,
    memberId: 'member_seed_parent_001',
    ...
    updatedBy: 'member_seed_parent_001',
  },
  {
    id: 'submission_seed_002',
    programId: 'scholarship_program_seed_2026',
    awardLevelId: 'award_level_seed_silver',
    clanId,
    memberId: 'member_seed_parent_002',
    ...
    reviewedBy: 'member_seed_parent_001',
...
const scholarshipApprovalLogs = [
  {
    id: 'sch_log_seed_001',
    clanId,
    submissionId: 'submission_seed_002',
    action: 'submission_reviewed',
    decision: 'approve',
    actorMemberId: 'member_seed_parent_001',
  ...
  },
  {
    id: 'sch_log_seed_002',
    clanId,
    submissionId: 'submission_seed_001',
...
const subscriptions = [
  {
    ...
    lastTransactionId: 'paytxn_seed_001',
    lastInvoiceId: 'invoice_seed_001',
    updatedAt: now,
    updatedBy: 'seed-script',
    createdAt: now,
    createdBy: 'seed-script',
...
const paymentTransactions = [
  {
    ...
    vatIncluded: true,
    currency: 'VND',
    gatewayReference: 'GPLAY-SEED-001',
...
const billingAuditLogs = [
  {
    id: 'billing_audit_seed_bootstrap',
    clanId,
  ...
  {
    id: 'billing_audit_seed_payment',
    clanId,
    actorUid: 'seed-script',
    action: 'payment_succeeded',
    entityType: 'paymentTransaction',
    entityId: 'paytxn_seed_001',
    before: { status: 'pending' },
    after: { status: 'succeeded', provider: 'google_play' },
...
const notifications = [
  {
    ...
    data: {
      target: 'event',
      eventId: 'event_seed_memorial_001',
      id: 'event_seed_memorial_001',
    },
  },
  {
    id: 'notif_seed_scholarship_001',
    clanId,
    memberId: 'member_seed_parent_002',
...
const governanceRoleAssignments = [
  {
    id: 'governance_assignment_seed_001',
    clanId,
    memberId: 'member_seed_parent_002',
    previousRole: 'MEMBER',
