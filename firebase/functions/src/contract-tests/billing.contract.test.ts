...
import {
  ...
  setBillingPricingTiersForTesting,
  shouldShowAds,
} from '../billing/pricing';
import { normalizeSubscriptionStatus } from '../billing/subscription-lifecycle';

const CONTRACT_IAP_IOS_BASE = 'ios_base_yearly';
const CONTRACT_IAP_IOS_PLUS = 'ios_plus_yearly';
const CONTRACT_IAP_IOS_PRO = 'ios_pro_yearly';
const CONTRACT_IAP_ANDROID_BASE = 'android_base_yearly';
const CONTRACT_IAP_ANDROID_PLUS = 'android_plus_yearly';
const CONTRACT_IAP_ANDROID_PRO = 'android_pro_yearly';
...
test(
  ...
  async () => {
    const {
      ...
      setIapProductCatalogForTesting,
    ...
    try {
      setIapProductCatalogForTesting([
        {
          ...
          data: {
            ...
            isActive: true,
            storeProductIds: {
              ios: CONTRACT_IAP_IOS_BASE,
              android: CONTRACT_IAP_ANDROID_BASE,
            },
          },
        },
        {
          ...
          data: {
            ...
            isActive: true,
            storeProductIds: {
              ios: CONTRACT_IAP_IOS_PLUS,
              android: CONTRACT_IAP_ANDROID_PLUS,
            },
          },
        },
        {
          ...
          data: {
            ...
            isActive: true,
            storeProductIds: {
              ios: CONTRACT_IAP_IOS_PRO,
              android: CONTRACT_IAP_ANDROID_PRO,
            },
          },
        },
      ]);
      ...
      setIapProductCatalogForTesting(null);
    }
  },
);
